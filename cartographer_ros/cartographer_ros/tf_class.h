...
#ifndef CARTOGRAPHER_TF_CLASS_H_
#define CARTOGRAPHER_TF_CLASS_H_
...
class TfClass{
 public:
    ...
    // geometry_msgs::TransformStamped transform_tf2_;
    ...
    bool GetTransform(const std::string &original_frame,
        ...
        try {
            ...
            if (listener_.waitForTransform(target_frame, original_frame,
                ...
                // transform_tf2_ = tf_to_tf2(transform_);
                } else {
...
#endif  // CARTOGRAPHER_TF_CLASS_H_